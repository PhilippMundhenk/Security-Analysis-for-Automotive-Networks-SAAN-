...
public class Interface_FlexRay_in extends Interface implements Interface_in {
	public Interface_FlexRay_in(Element element) {
		super(element);
	}

	public Interface_FlexRay_in(String string) {
		super(string);
	}

	public Interface_FlexRay_in(String ecuID, String busID) {
